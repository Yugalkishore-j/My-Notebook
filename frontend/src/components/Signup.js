  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
            ...
            <input type="password" name="password"  onChange={onChange} id="password" value={credentials.password} className="form-control"  autoComplete="new-password" />
            <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
        </div>
        <div className="mb-3">
            <label htmlFor="cpassword" className="form-label">Confirm Password</label>
            <input type="password" name="cpassword"  onChange={onChange} id="cpassword" value={credentials.cpassword} className="form-control"  autoComplete="new-password" />
        </div>
